...
Friend Class frmStoreEqptEntry
    ...
    Private Sub set_dgAccountEqptData(ByRef bFlag As General.modo, ByRef nAccountStatus As General.EqptStatus)
        ...
        End Select
        'MsgBox sStmt
        'UPGRADE_NOTE: Object dgAccountEqpt.DataSource may not be destroyed until it is garbage collected. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6E35BFF6-CD74-4B09-9689-3E1A43DF8969"'
