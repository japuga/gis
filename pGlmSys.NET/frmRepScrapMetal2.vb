...
Friend Class frmRepScrapMetal2
	...
	Private Function get_criteria() As Boolean
		...
		ElseIf obRangePeriod.Checked Then 
            ...
            If rs.Rows.Count > 0 Then
                For row As Integer = 0 To rs.Rows.Count
...
ErrorHandler: 
	...
	Private Sub show_report2()
		...
		cmReport.CommandText = "usp_rep_scrap_metal2"
        ...
        cmReport.Parameters("@sFilter").Direction = ParameterDirection.Output
		...
		sStmt = "SELECT count(*) FROM RptScrapMetal2 WHERE report_id = " & Str(nReport)
        ...
        Try
            sStmt = " SELECT * " & " FROM RptScrapMetal2 " & " WHERE report_id = " & Str(nReport) & " ORDER BY store_no, store_address, vendor_name, " & " account_desc, invoice_desc, eqpt_mask, " & " content_desc DESC, eqpt_freq, serv_desc "
	...
	Private Sub frmRepScrapMetal2_Load(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Load
		init_vars()
	End Sub
