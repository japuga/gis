	...
	Private Sub load_dgService()
        ...
        If rsLocal.Rows.Count > 0 Then
            For row As Integer = 0 To rsLocal.Rows.Count - 1
                If rsLocal.Rows(row).Item("serv_id").Value = gServiceRecord.serv_id Then
                    bFound = True
                    Exit For
                End If
            Next row
...
ErrorHandler:
	...
	Private Sub update_service()
		...
		If dgService.SelBookmarks.Count > 0 Then
	...
	Private Sub set_service()
        ...
        gServiceRecord.serv_id = rsLocal.Rows(0).Item("serv_id").Value
		'Desc
		'UPGRADE_WARNING: Use of Null/IsNull() detected. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="2EED02CB-5C0E-4DC1-AE94-4FAA3A30F51A"'
        If IsDBNull(rsLocal.Rows(0).Item("Name").Value) Then
            gServiceRecord.serv_desc = ""
        Else
            gServiceRecord.serv_desc = Trim(rsLocal.Rows(0).Item("Name").Value)
        End If
		'serv_eqpt
		'UPGRADE_WARNING: Use of Null/IsNull() detected. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="2EED02CB-5C0E-4DC1-AE94-4FAA3A30F51A"'
        If IsDBNull(rsLocal.Rows(0).Item("Eqpt").Value) Then
            gServiceRecord.serv_eqpt = "F"
        Else
            gServiceRecord.serv_eqpt = rsLocal.Rows(0).Item("Eqpt").Value
        End If
		'Credit
		'UPGRADE_WARNING: Use of Null/IsNull() detected. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="2EED02CB-5C0E-4DC1-AE94-4FAA3A30F51A"'
        If IsDBNull(rsLocal.Rows(0).Item("Cred").Value) Then
            gServiceRecord.serv_credit = "F"
        Else
            gServiceRecord.serv_credit = rsLocal.Rows(0).Item("Cred").Value
        End If
		'serv_rate_contract
		'UPGRADE_WARNING: Use of Null/IsNull() detected. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="2EED02CB-5C0E-4DC1-AE94-4FAA3A30F51A"'
        If IsDBNull(rsLocal.Rows(0).Item("Contract").Value) Then
            gServiceRecord.serv_rate_contract = "F"
        Else
            gServiceRecord.serv_rate_contract = rsLocal.Rows(0).Item("Contract").Value
        End If
		'serv_measure_unit
		'UPGRADE_WARNING: Use of Null/IsNull() detected. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="2EED02CB-5C0E-4DC1-AE94-4FAA3A30F51A"'
        If IsDBNull(rsLocal.Rows(0).Item("serv_measure_unit").Value) Then
            gServiceRecord.serv_measure_unit = ""
        Else
            gServiceRecord.serv_measure_unit = Trim(rsLocal.Rows(0).Item("serv_measure_unit").Value)
        End If
		'unit_desc
		'UPGRADE_WARNING: Use of Null/IsNull() detected. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="2EED02CB-5C0E-4DC1-AE94-4FAA3A30F51A"'
        If IsDBNull(rsLocal.Rows(0).Item("Unit").Value) Then
            gServiceRecord.unit_desc = ""
        Else
            gServiceRecord.unit_desc = Trim(rsLocal.Rows(0).Item("Unit").Value)
        End If
		'Class
		'UPGRADE_WARNING: Use of Null/IsNull() detected. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="2EED02CB-5C0E-4DC1-AE94-4FAA3A30F51A"'
        If IsDBNull(rsLocal.Rows(0).Item("Class").Value) Then
            gServiceRecord.serv_class = ""
        Else
            gServiceRecord.serv_class = rsLocal.Rows(0).Item("Class").Value
        End If
		'Class Id
		'UPGRADE_WARNING: Use of Null/IsNull() detected. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="2EED02CB-5C0E-4DC1-AE94-4FAA3A30F51A"'
        If IsDBNull(rsLocal.Rows(0).Item("serv_class_id").Value) Then
            gServiceRecord.serv_class_id = ""
        Else
            gServiceRecord.serv_class_id = rsLocal.Rows(0).Item("serv_class_id").Value
        End If
		
		'Frequency
		'UPGRADE_WARNING: Use of Null/IsNull() detected. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="2EED02CB-5C0E-4DC1-AE94-4FAA3A30F51A"'
        If IsDBNull(rsLocal.Rows(0).Item("Freq").Value) Then
            gServiceRecord.serv_frequency = ""
        Else
            gServiceRecord.serv_frequency = rsLocal.Rows(0).Item("Freq").Value
        End If
		
		'ServIdConversion
		'UPGRADE_WARNING: Use of Null/IsNull() detected. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="2EED02CB-5C0E-4DC1-AE94-4FAA3A30F51A"'
        If IsDBNull(rsLocal.Rows(0).Item("serv_id_conversion").Value) Then
            gServiceRecord.serv_id_conversion = 0
        Else
            gServiceRecord.serv_id_conversion = rsLocal.Rows(0).Item("serv_id_conversion").Value
        End If
	End Sub
End Class